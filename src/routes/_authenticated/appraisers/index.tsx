...
import type { TAppraiser, TCommentsForOpinion } from '../../../types'
...
import AppraisersForm from '../../../components/Opinions/AppraisersForm'
import { useAddAppraiserMutation, useAppraiserDeleteMutation, useAppraisersQuery, useUpdateAppraiserMutation } from '../../../query/appraisers.query'


export const Route = createFileRoute('/_authenticated/appraisers/')({
  component: AppraisersPage,
})
