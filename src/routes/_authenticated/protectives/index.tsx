...
import { useProtectivesAddMutation, useProtectivesDeleteMutation, useProtectivesQuery, useProtectivesUpdateMutation } from '../../../query/protectives.query'
import ProtectivesForm from '../../../components/Protectives/ProtectivesForm'



export const Route = createFileRoute('/_authenticated/protectives/')({
  component: ProtectivesPage,
})

function ProtectivesPage() {
