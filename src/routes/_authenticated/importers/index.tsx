...
function ImportersPage() {
  ...
  const columns = [
    {
      field: 'name',
      headerName: t('name', { ns: 'importers' }),
      editable: false,
      hideable: true,
      type: 'string',
      flex: 1,
      valueGetter: (_value: any, row: TImporter) => row.name,
    },
    {
      field: 'nameEn',
      headerName: t('nameEn', { ns: 'importers' }),
      editable: false,
      hideable: true,
      type: 'string',
      flex: 1,
      valueGetter: (_value: any, row: TImporter) => row.nameEn,
    },
    {
      field: 'actions',
      type: 'actions',
  ...
  return (
    <Grid container spacing={3} >
      ...
      >
        <AppDataGrid
          tableName='importersTable'
          rows={importers ?? []}
          columns={columns as GridColDef<TImporter>[]}
          editMode='row'
          isLoading={isLoading}
