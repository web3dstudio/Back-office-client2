...
import type { TIcon, TUpgradePackage } from "../../types"
...
interface Props {
	data: TUpgradePackage | null
	isPending: boolean
	onCancel: () => void
	onConfirm: (data: TUpgradePackage) => void
}

type TFormInput = Omit<TUpgradePackage, 'id' | 'iconId' | 'icon'>

function UpgradePackagesForm({ data, isPending, onCancel, onConfirm }: Props) {
	...
	const onSubmit = (data: any) => {
		onConfirm({ ...data, iconId: selectedIcon?.id || null } as TUpgradePackage)
		reset()
	}
...
export default UpgradePackagesForm