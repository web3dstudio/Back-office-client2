...
interface Props {
  data: TProtective | null
  isPending: boolean
  onCancel: () => void
  onConfirm: (data: TProtective) => void
}

type TFormInput = Omit<TProtective, 'id'>

function ProtectivesForm({ data, isPending, onCancel, onConfirm }: Props) {
      ...
      <Grid container sx={{ mt: 1 }}>
        <Grid size={12}>
          <AppControlledTextField
            ...
            control={control}
            errors={errors}
            label={t('name', { ns: 'protectives' })}
            placeholder={t('name', { ns: 'protectives' })}
          />
        </Grid>
        <Grid size={12}>
          <AppControlledTextField
            ...
            control={control}
            errors={errors}
            label={t('nameEn', { ns: 'protectives' })}
            placeholder={t('nameEn', { ns: 'protectives' })}
          />
        </Grid>
...
export default ProtectivesForm