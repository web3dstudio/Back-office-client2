...
interface Props {
  ...
  isPending: boolean
  onCancel: () => void
  onConfirm: (data: TCountry) => void
}

type TFormInput = Omit<TCountry, 'id'>

function CountryForm({ data, isPending, onCancel, onConfirm }: Props) {
      ...
      <Grid container sx={{ mt: 1 }}>
        <Grid size={12}>
          <AppControlledTextField
            ...
            placeholder={t('name', { ns: 'countries' })}
          />
        </Grid>
        <Grid size={12}>
          <AppControlledTextField
            ...
            control={control}
            errors={errors}
            label={t('nameEn', { ns: 'countries' })}
            placeholder={t('nameEn', { ns: 'countries' })}
          />
        </Grid>
