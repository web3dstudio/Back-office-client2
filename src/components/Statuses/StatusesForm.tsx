...
import type { TExternalStatus, TInternalStatus } from "../../types"
...
interface Props {
  data: TExternalStatus | TInternalStatus | null
  isPending: boolean
  onCancel: () => void
  onConfirm: (data: TExternalStatus | TInternalStatus) => void
}

type TFormInput = Omit<TExternalStatus, 'id'> | Omit<TInternalStatus, 'id'>

function StatusesForm({ data, isPending, onCancel, onConfirm }: Props) {
